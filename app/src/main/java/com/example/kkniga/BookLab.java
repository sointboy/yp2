...
import com.example.kkniga.database.BookBaseHelper;
import com.example.kkniga.database.BookCursorWrapper;
import com.example.kkniga.database.BookDbSchema;
...
public class BookLab {
    ...
    public List<Book> getBooks() {
        ...
        BookCursorWrapper cursor = queryBooks(null, null); try {
            cursor.moveToFirst();
            while (!cursor.isAfterLast()) { books.add(cursor.getBook()); cursor.moveToNext();
            }
        } finally {
            cursor.close();
        }
